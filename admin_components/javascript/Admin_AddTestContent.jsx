...
class Admin_AddTestContent extends Component {
...
constructor(props){
    ...
    this.addtestdetails=this.addtestdetails.bind(this)
    ...
    addtestdetails(){      
       Adminapi.submitAddTestDetails(this.state.cname,{
            ...
            <div>
                ...
                <table >                  
                    ...
                    <tr>
                            ...
                            <button class="submit" onClick={this.addtestdetails}>Submit </button>
                    </tr>
                </table>
             </div>
        </div>
...
export default Admin_AddTestContent;